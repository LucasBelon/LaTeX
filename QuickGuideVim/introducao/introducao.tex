...
Usando \vimcommand{:set showcmd} à direita, aparecerão, de vez em quando,
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.8]{introducao/modo_visual.jpg}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.8]{introducao/modo_visual_linha.jpg}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.8]{introducao/modo_visual_bloco.jpg}
