...
O comando \backslash tableofcontents responde aos comandos que definem títulos e subtítulos:
\backslash chapter, \backslash section \backslash subsection \backslash subsubsection.
...
com asterisco, como \backslash section*, que afeta a exibição
...
\textbf{
    ...
    \backslash fancyhdr\{\} \\
    \backslash fancyhead[LE]\{\backslash leftmark\} \\
    \backslash fancyhead[RO]\{\backslash nouppercase\{\backslash rightmark\}\} \\
    \backslash fancyfoot[LE,RO]\{\backslash thepage\} \\
    \backslash pagestyle\{fancy\} \\

}

Deve srr aplicado no preambilo.
