...
% Small caps não é uma boa ideia {\slshape slanted} or typeset in {\scshape Small Caps}.
...
Uso genérico do parbox \textbackslash parbox[alignment]\{width\}\{text\}
\begin{itemize}
        ...
        \item Largura: Largura cuja caixa irá tomar. Pode ser dado em cm, em mm ou em in.
...
\fbox{ \parbox[b]{1cm}{Default parbox within fbox} }
